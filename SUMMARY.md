...
* [Fase 2 - Explotación](method/explotacion/README.md)
  * [Shells](method/explotacion/shells.md)
    * [Diferencia entre una WebShell y Reverse Shell](method/explotacion/shells/diferencia-entre-una-webshell-y-reverse-shell.md)
...
* [Fase 3 - Post Explotación](method/post-exploit/README.md)
  * [Enumeración](method/post-exploit/enumeracion/README.md)
  * [Linux](method/post-exploit/linux/README.md)
...
* [S3](aws-pentesting/s3/README.md)
  ...
  * [S3\_public](aws-pentesting/s3/s3_public.md)
...
* [EC2](aws-pentesting/ec2/README.md)
  ...
  * [Privesc-Paths](aws-pentesting/ec2/privesc-paths/README.md)
    * [EC2\_SSRF](aws-pentesting/ec2/privesc-paths/ec2_ssrf.md)
    ...
    * [ECS\_takeover](aws-pentesting/ec2/privesc-paths/ecs_takeover.md)
...
* [Introducción a Red Team](red_team/introduccion-a-red-team/README.md)
  * [Assume breach](red_team/introduccion-a-red-team/assume-breach.md)
* [¿Qué es MITRE ATT\&CK?](red_team/que-es-mitre-att-and-ck/README.md)
  * [Guia de uso de Invoke-AtomicRedTeam](red_team/que-es-att-and-ck/guia-de-uso-de-invoke-atomicredteam.md)
* [C2 Comando y control](red_team/c2-comando-y-control/README.md)
  * [Sliver C2](red_team/c2-comando-y-control/sliver-c2/README.md)
    * [Instalación](red_team/c2-comando-y-control/sliver-c2/instalacion.md)
    * [Beacons y Sesiones](red_team/c2-comando-y-control/sliver-c2/beacons-y-sesiones.md)
    * [Perfiles](red_team/c2-comando-y-control/sliver-c2/perfiles.md)
    * [mTLS y WiewGuard](red_team/c2-comando-y-control/sliver-c2/mtls-y-wiewguard.md)
    * [HTTP / HTTPS](red_team/c2-comando-y-control/sliver-c2/http-https.md)
    * [DNS](red_team/c2-comando-y-control/sliver-c2/dns.md)
    * [Stagers: Basics](red_team/c2-comando-y-control/sliver-c2/stagers-basics.md)
    * [Stagers: Proccess Injection](red_team/c2-comando-y-control/sliver-c2/stagers-proccess-injection.md)
    * [Basics de Implates](red_team/c2-comando-y-control/sliver-c2/basics-de-implates.md)
    * [Ejecución de Assembly](red_team/c2-comando-y-control/sliver-c2/ejecucion-de-assembly.md)
    * [Sideload](red_team/c2-comando-y-control/sliver-c2/sideload.md)
    * [SpawnDLL](red_team/c2-comando-y-control/sliver-c2/spawndll.md)
    * [Sliver Extensions](red_team/c2-comando-y-control/sliver-c2/sliver-extensions.md)
...
* [Ataques en AD](active-directory/ataques-en-ad/README.md)
  * [Mimikats](active-directory/ataques-en-ad/mimikats/README.md)
    * [Comandos](active-directory/ataques-en-ad/mimikats/comandos.md)
  * [Password Spraying](active-directory/ataques-en-ad/password-spraying.md)
  * [LLMNR Poisoning](active-directory/ataques-en-ad/llmnr-poisoning.md)
  * [Relay Attacks](active-directory/ataques-en-ad/relay-attacks/README.md)
    * [NTLM](active-directory/ataques-en-ad/relay-attacks/ntlm.md)
  * [Kerberoasting](active-directory/ataques-en-ad/kerberoasting.md)
* [Tools](active-directory/tools/README.md)
  * [AuxRecon](active-directory/tools/auxrecon.md)
  * [Powershell](active-directory/tools/powershell.md)
  * [PowerView.ps1](active-directory/tools/powerview.ps1.md)
  * [ADPeas](active-directory/tools/adpeas.md)
  * [Mimikatz](active-directory/tools/mimikatz/README.md)
    * [Comandos](active-directory/tools/mimikatz/comandos.md)
